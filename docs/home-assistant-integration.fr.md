...
**Cas d'usage :** fail-safe de charge réseau si le heartbeat s'arrête, mises à jour via l'entité Update, et automatisations sur le binaire Healthy — voir la [version anglaise](home-assistant-integration.md#use-cases).
