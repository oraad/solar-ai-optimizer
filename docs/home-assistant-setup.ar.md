...
مطلوب لعمليات نشر Docker وProxmox (يستخدم تطبيق HA رمز المشرف تلقائيًا عندما تُترك الحقول فارغة).
...
بالنسبة إلى **تطبيق HA**، اترك عنوان URL/الرمز المميز فارغًا للاستخدام `http://supervisor/core` و `SUPERVISOR_TOKEN`.
