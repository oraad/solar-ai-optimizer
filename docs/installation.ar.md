...
| [الوظيفة الإضافية لمساعد المنزل](#home-assistant-add-on)| HAOS / تحت الإشراف | مشرف`/data` |
...
## الوظيفة الإضافية لمساعد المنزل {#home-assistant-add-on}

!!! tip "أفضل تكامل لمساعد المنزل"
لوحة الدخول الأصلية، والرمز المميز للمشرف التلقائي، ولا توجد أسلاك يدوية لعنوان URL لـ HA
يتم ترك بيانات الاعتماد فارغة في خيارات الوظائف الإضافية.

** المتطلبات الأساسية: ** نظام التشغيل Home Assistant أو التثبيت الخاضع للإشراف مع إمكانية الوصول إلى المتجر الإضافي.
...
3. ابدأ تشغيل الوظيفة الإضافية وافتح **لوحة الدخول** من الشريط الجانبي لـ HA (الرمز: اللوحة الشمسية).

يتم إنشاء الوظيفة الإضافية من المستودع`Dockerfile`وتستمر الدولة تحت`/data`
(قاعدة البيانات، تكوين وقت التشغيل، النموذج المستفادة). تعيين خيارات الوظيفة الإضافية لمتغيرات البيئة
...
6. قم باستيراد الملف بشكل اختياري[حزمة HA آمنة من الفشل](home-assistant-failsafe.md)وقم بتمكين نبضات القلب في الإعدادات → Fail-safe
