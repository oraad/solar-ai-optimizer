...
6. Installez éventuellement l'[intégration HACS Solar AI Optimizer](https://oraad.github.io/solar-ai-integration/home-assistant-integration/) pour la sécurité côté HA et les mises à jour ; activez l'arrêt de sécurité dans Paramètres → Sécurité si souhaité
