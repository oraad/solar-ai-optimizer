...
**Home Assistant:** ثبّت [تكامل HACS](https://oraad.github.io/solar-ai-integration/home-assistant-integration/) من [`oraad/solar-ai-integration`](https://github.com/oraad/solar-ai-integration). أنشئ رمز اقتران من إعدادات Solar ثم أضف التكامل في HA (Core 2026.7.0+).
