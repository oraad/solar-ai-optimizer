...
**Home Assistant:** Install the [HACS integration](https://oraad.github.io/solar-ai-optimizer/home-assistant-integration/) for fail-safe and Update entities. Generate a pairing code in Solar Settings, then add the integration in HA (Core 2026.3.0+).
